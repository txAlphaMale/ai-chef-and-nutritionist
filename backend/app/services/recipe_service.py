...
RULES:
1. Take each ingredient's quantity and unit from the source and never change the unit: "2 Tbsp." stays quantity 2 with unit "Tbsp.", never rewritten as cups or any other unit. "quantity" is a NUMBER, so an amount the source writes as a fraction is written as its decimal value: 1/4 and ¼ are 0.25, 1/2 and ½ are 0.5, 3/4 and ¾ are 0.75, 1¼ is 1.25, 1/3 is 0.33. Writing a stated fraction as a decimal is NOT converting the unit and NOT inventing an amount -- it is the same amount the source gives, in the form this field takes. Leave quantity and unit null ONLY when the source states no amount at all for that ingredient.
