...
_PREPARATION_WORDS = frozenset(
    {
        ...
        "chopped", "diced", "minced", "sliced", "shredded", "grated", "crushed", "mashed",
        "cubed", "julienned", "halved", "quartered", "peeled", "seeded", "cored", "pitted",
        "trimmed", "deboned", "shelled", "husked", "zested", "beaten", "whisked", "sifted",
        # state at time of use
        "melted", "softened", "thawed", "defrosted", "drained", "rinsed", "washed", "packed",
        "rounded", "heaping", "level", "warmed", "chilled", "cooled",
        # adverbs that only ever qualify one of the above
        "finely", "roughly", "thinly", "thickly", "coarsely", "freshly", "lightly", "well",
        "very", "approximately", "about",
        # size / grade / marketing qualifiers
        "large", "small", "medium", "extra", "jumbo", "baby", "mini", "fresh", "ripe",
        "organic", "natural", "premium", "quality", "grade", "boneless", "skinless",
        # recipe-list bookkeeping that survives parsing
        "divided", "optional", "needed", "taste", "garnish", "serving", "topping",
        "room", "temperature",
    }
)
...
DEFAULT_TRANSFORMATION_WORDS: tuple[str, ...] = (
    "broth", "stock", "bouillon", "consomme", "soup", "sauce", "gravy", "paste", "puree",
    "concentrate", "extract", "essence", "oil", "butter", "margarine", "shortening", "lard",
    "milk", "cream", "creamer", "yogurt", "cheese", "flour", "meal", "starch", "powder",
    "granules", "juice", "cider", "nectar", "syrup", "jam", "jelly", "preserves", "marmalade",
    "vinegar", "wine", "liqueur", "seasoning", "rub", "marinade", "dressing", "dip", "spread",
    "chips", "crisps", "crackers", "jerky", "sausage", "bacon", "ham", "salami", "pepperoni",
    "bread", "roll", "bun", "tortilla", "pasta", "noodles", "cereal", "granola", "bar",
    "water", "tea", "coffee", "smoothie", "shake",
)
